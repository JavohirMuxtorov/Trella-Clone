...
class MyProfileActivity : BaseActivity() {
    companion object{
        private const val READ_STORSGE_PERMISSION_CODE = 1
    ...
    override fun onRequestPermissionsResult(
        ...
        if (requestCode == READ_STORSGE_PERMISSION_CODE){
    ...
    private fun showImageChooser(){
        ...
        startActivityForResult(galeryIntent, PICK_IMAGE_REQUEST_CODE)
